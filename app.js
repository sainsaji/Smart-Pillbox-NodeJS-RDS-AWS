...
app.get('/',(req, res)=>{
    ...
    let sql2 ="CREATE TABLE IF NOT EXISTS ?? (ID int AUTO_INCREMENT NOT NULL,patientname VARCHAR(255),caretaker VARCHAR(255),caretakernum int(11),start_date timestamp,schedulestatus , mybool boolean not null default 0 ,PRIMARY KEY(ID))";
